...
#     docs = docs.replace("\\n", " ")
#     # print(docs[2:100])
#     ques_details.append(docs[0:200])
#     # print("\n")
...
titles = []
f1_titles = open('./Titles.txt', encoding='utf-8')
...
URLs = []
f1_URL = open('./Problems_urls.txt', encoding='utf-8')
...
for i in (range(len(similarity[0:5]))):
    ...
    docs = docs.replace("\\n", " ")
    # print(docs[2:100])
    ques_details.append(docs[1:100])
    # print("\n")
    arr.append(ques_details)
print(arr)